...
class FS:
    ...
    def findDirToDelete(self, min_size: int) -> int:
        q:list[Dir] = []
        seen: set[str] = set()
...
def solve(lines: list[str]) -> int:
    ...
    print()
    free_space: int = total_space - fs.getRootSize()
    print(f"Unused disk space: {free_space}, space required: {space_required - free_space}")
    return fs.findDirToDelete(space_required - free_space)
